    ...
    Editor.init = function () {
      ...
      */
      ...
      var showSvgIframe = function (e) {
        ...
        // obtengo el svg y lo pinto en el modal.
        var stringCanvas = svgCanvas.svgCanvasToString();
        $('#svg_iframe').empty();
        d3.select('#svg_iframe').html(stringCanvas)
      ...
      /**
       * Se conecta a mqtt a la espera de mensajes que modifiquen los dibujos mostrados.
       * @author Carlos Emanuel Balcazar
       */
      function connectToMqtt() {
        ...
        var client = new Paho.MQTT.Client(window.location.host, 9001, '', clientId.toString());
